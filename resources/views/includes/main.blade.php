<div id="donors" class="content" data-scrollview="true">
    <!-- begin container -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <div class="team">
                    <div class="image" data-animation="true" data-animation-type="flipInX">
                        <img src="images/user-1.jpg" alt="Ryan Teller" />
                    </div>
                    <div class="info">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <div class="team">
                    <div class="image" data-animation="true" data-animation-type="flipInX">
                        <img src="images/user-2.jpg" alt="Jonny Cash" />
                    </div>
                    <div class="info">
                        <h3 class="name">ЈосиФ Сиркаров</h3>
                        <div class="title text-theme">ЗЕМЈОДЕЛЕЦ</div>
