                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="well well-sm">
                                <form role="form" method="POST" action="{{route('admin.contacts.store')}}">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Внеси name" required="required" />
                                            </div>
                                            <div class="form-group">
                                                <label for="email">
                                ...
                                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                                                    ...
                                                    <input type="email" name="email" class="form-control" id="email" placeholder="Внеси email" required="required" /></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="subject">
