...
@section('content')
    <div class="container" style="padding-top:50px;padding-bottom:150px">
        <div class="row">
            <div class="col-lg-9"><h1 style="margin-left: 35px;">{{$user->name }} {{$user->surname}}</h1></div>
            <div class="col-lg-2">
                <a class="btn btn-block btn-warning edit-profile-btn"  href="/blood_donors"><span class="glyphicon glyphicon-arrow-left"></span> Крводарители</a>
            </div>
        </div>
        <div class="row">
